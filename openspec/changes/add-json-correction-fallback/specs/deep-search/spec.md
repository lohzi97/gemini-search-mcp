...
The `deep_search` tool SHALL support optional model configuration for both main search rounds and JSON correction tasks. When no model is specified, Gemini CLI shall auto-select the model.
